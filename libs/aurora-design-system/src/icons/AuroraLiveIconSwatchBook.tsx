...
interface AuroraLiveIconSwatchBookProps extends React.SVGAttributes<SVGSVGElement> {
  width?: number;
  height?: number;
  strokeWidth?: number;
  stroke?: string;
...
const AuroraLiveIconSwatchBook = ({
  width = 28,
  height = 28,
  strokeWidth = 2,
  stroke = "#ffffff",
  ...props
}: AuroraLiveIconSwatchBookProps) => {
...
export { AuroraLiveIconSwatchBook };
