...
interface AuroraLiveIconPartyPopperProps extends React.SVGAttributes<SVGSVGElement> {
  width?: number;
  height?: number;
  strokeWidth?: number;
  stroke?: string;
...
const AuroraLiveIconPartyPopper = ({
  width = 28,
  height = 28,
  strokeWidth = 2,
  stroke = "#ffffff",
  ...props
}: AuroraLiveIconPartyPopperProps) => {
...
export { AuroraLiveIconPartyPopper };
