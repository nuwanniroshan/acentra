...
interface AuroraLiveIconPackageOpenProps extends React.SVGAttributes<SVGSVGElement> {
  width?: number;
  height?: number;
  strokeWidth?: number;
  stroke?: string;
...
const AuroraLiveIconPackageOpen = ({
  width = 28,
  height = 28,
  strokeWidth = 2,
  stroke = "#ffffff",
  ...props
}: AuroraLiveIconPackageOpenProps) => {
...
export { AuroraLiveIconPackageOpen };
