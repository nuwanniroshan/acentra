...
interface AuroraLiveIconCloudDrizzleProps extends React.SVGAttributes<SVGSVGElement> {
  width?: number;
  height?: number;
  strokeWidth?: number;
  stroke?: string;
...
const AuroraLiveIconCloudDrizzle = ({
  width = 28,
  height = 28,
  strokeWidth = 2,
  stroke = "#ffffff",
  ...props
}: AuroraLiveIconCloudDrizzleProps) => {
...
export { AuroraLiveIconCloudDrizzle };
