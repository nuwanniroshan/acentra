...
interface AuroraLiveIconCircleDashedProps extends React.SVGAttributes<SVGSVGElement> {
  width?: number;
  height?: number;
  strokeWidth?: number;
  stroke?: string;
...
const AuroraLiveIconCircleDashed = ({
  width = 28,
  height = 28,
  strokeWidth = 2,
  stroke = "#ffffff",
  ...props
}: AuroraLiveIconCircleDashedProps) => {
...
export { AuroraLiveIconCircleDashed };
