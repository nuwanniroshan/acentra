...
interface AuroraLiveIconOrigamiProps extends React.ComponentProps<typeof motion.svg> {
  width?: number;
  height?: number;
  strokeWidth?: number;
  stroke?: string;
...
const AuroraLiveIconOrigami = ({
  width = 28,
  height = 28,
  strokeWidth = 2,
  stroke = "#ffffff",
  ...props
}: AuroraLiveIconOrigamiProps) => {
