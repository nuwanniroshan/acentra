...
export function CandidateDetailsDrawer({
  ...
  const [questionnaires] = useState({
    whyWorkHere:
      "I am passionate about this company's mission and believe my skills align perfectly with the role requirements.",
            ...
            {activeTab === 1 && (
              <AuroraBox>
                ...
                <AuroraBox sx={{ mt: 3 }}>
                  ...
                  >
                    <AuroraTypography variant="body2">
                      {questionnaires.salaryExpectations}
                    </AuroraTypography>
                  </AuroraPaper>
                  ...
                  >
                    <AuroraTypography variant="body2">
                      {new Date(questionnaires.startDate).toLocaleDateString()}
                    </AuroraTypography>
                  </AuroraPaper>
                  ...
                  >
                    <AuroraTypography variant="body2">
                      {questionnaires.willingToRelocate === "yes"
                        ? "Yes"
                        : "No"}
                    </AuroraTypography>
                  </AuroraPaper>
